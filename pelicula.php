...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          ...
          <i class="bi bi-phone d-flex align-items-center ms-4"><span>+34 916738191</span></i>
        </div>
        <div id="cuadro_usuario"><a href="#"><img id="avatar" src="assets/img/avatar.png" alt="Avatar"></a><h6><?php echo $_SESSION['username']?></h6></div>
        <button id="boton_modal" type="button" class="btn btn-success" style="background:#ff5821; margin-left: 20px; border-radius: 0px;" data-bs-toggle="modal" href="#login">Iniciar Sesión</button>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                      ...
                      <input type="name" name="newusername" class="form-control" id="newusername" placeholder="Introduce tu nombre de usuario" pattern="[a-zA-Z0-9]+" required>
                  </div>

                  <div class="mb-3">
                      <label style="color:black" for="newemail">Email<span class="text-danger">*</span></label>
                      <input type="email" name="newemail" class="form-control" id="newemail" placeholder="Introduce tu email" required>
                  </div>
  ...
  <!-- ======= Header ======= -->
    <header id="header" style="height: 70px;" class="d-flex align-items-center">
        ...
        <a href="index.php"><img style="width:75px" src="assets/img/cineGalaxy.png" alt=""></a>
      ...
      $('#boton_registro').click(function(){
        ...
        else
        {
          ...
          {  
            url:"registro.php",  
            type:"POST",  
            data: {newusername:newusername, newemail:newemail, newpassword:newpassword, newpassword2:newpassword2},  
            ...
            { 
              ...
              if(msg == 'ok')
              {
                ...
                $('#cuadro_usuario').css('display','flex'); 
              }
              else
              {
                $('#error').css('display','block'); 
